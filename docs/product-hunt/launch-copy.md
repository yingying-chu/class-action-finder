...
Choose the closest available Product Hunt tags:

- Artificial Intelligence
- Productivity
- Open Source

If `Legal Tech` is available, use it instead of `Productivity`.

## Primary URL

https://github.com/yingying-chu/class-action-finder

## Additional link

https://yingying-chu.github.io/class-action-finder/demo-report.html
