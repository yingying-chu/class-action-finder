...
- **Generated-report destinations are semantic.** Use `action-queue`, `purchase-matches`, `active`, `watching`, `expired`, `filed`, `paid`, and `security`; positional IDs such as `sec1` are drift.
